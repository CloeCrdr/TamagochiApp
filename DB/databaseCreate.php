...
try {
    Database::migrate("tamagotchiProject", [
        ...
        new Table("tamagotchi", "id", [
            ...
            new Column("faim", "int(2) unsigned", "not null"),
            new Column("soif", "int(2) unsigned", "not null"),
            new Column("ennui", "int(2) unsigned", "not null"),
            new Column("sommeil", "int(2) unsigned", "not null"),
            new Column("living",  "int(2) unsigned", "not null"),
